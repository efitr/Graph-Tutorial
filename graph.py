...
## This is meant for a:
'''
    - Directed or undirected - the difference lies in that in 
                                                directed: only needs unidirectional
                                                          add_func
'''
...
# class Point(object): # Worst one on my opinion
    ...
    # def __init__(self, vertex, neighbor_list=None):
        """Initialize a vertex and its neighbors.
        neighbors: set of vertices adjacent to self,
        stored in a dictionary with key = vertex,
        value = weight of edge between self and neighbor.
        """
        # This is the name, been a string
        self.id = str(vertex)
        # This is a OrderedDict, remenber the order added elements
